...
## 📖 Описание
**WeBIOS** — это минималистичный BIOS, написанный на чистом **C** без использования внешних библиотек.  
Он эмулирует ключевые функции настоящего BIOS: загрузку ОС, работу с CMOS, IDE, клавиатурой и видеопамятью.  
